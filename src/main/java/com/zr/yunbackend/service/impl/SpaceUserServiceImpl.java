...
import com.zr.yunbackend.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    //校验空间成员对象，add=true 创建时校验 =false 编辑时校验
    @Override
    public void validSpaceUser(SpaceUser spaceUser, boolean add) {
        ...
        if (add) {
            ...
            SpaceUser existingSpaceUser = this.getOne(queryWrapper, false);
            ThrowUtils.throwIf(existingSpaceUser != null, ErrorCode.OPERATION_ERROR, "该成员已存在于空间中");
            //创建空间角色时要判断对应空间和该用户是否存在
